    ...
    <div class="nota-pedido">
        <div class="fecha">
            <div class="content-fecha" style="padding-top: 15px;">
                <small>N°: <b>{{ $budget->budget_no }}</b></small>
                <br>
                <small>Fecha: <b>{{ $budget->budget_date_receipt_formatted }}</b></small>
                <br>
        ...
        <div>PRESUPUESTO</div>
        <div style="font-size: 12px; color: red;">ESTE DOCUMENTO NO ES VÁLIDO COMO FACTURA</div>
        ...
        <div class="resumen">
            <div><strong>Total:</strong> <b>$ {{ number_format($budget->total, 0, ',', '.') }}</b></div>
        </div>
