                        ...
                        <form action="{{ route('employees.update', $employee->id) }}" method="POST"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="email">Correo Electrónico del Empleado <span
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="experience">
                                        ...
                                        <option value="1 Year" @if (old('experience', $employee->experience) == '1 Year') selected="selected" @endif>
                                            1 Año</option>
                                        <option value="2 Year" @if (old('experience', $employee->experience) == '2 Year') selected="selected" @endif>
                                            2 Años</option>
                                        <option value="3 Year" @if (old('experience', $employee->experience) == '3 Year') selected="selected" @endif>
                                            3 Años</option>
                                        <option value="4 Year" @if (old('experience', $employee->experience) == '4 Year') selected="selected" @endif>
                                            4 Años</option>
