                    ...
                    <div class="card-body">
                        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="email">Correo Electrónico del Proveedor <span
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" name="type"
                                        ...
                                        <option value="Distributor"
                                            @if (old('type', $supplier->type) == 'Distributor') selected="selected" @endif>Distribuidor
                                        </option>
                                        <option value="Whole Seller"
                                            @if (old('type', $supplier->type) == 'Whole Seller') selected="selected" @endif>Mayorista</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group col-md-12">
                                    <label for="address">Dirección del Proveedor <span
                                            class="text-danger">*</span></label>
