                        ...
                        <form action="{{ route('attendence.store') }}" method="POST">
                            ...
                            <div class="row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="datepicker" disabled class="form-control @error('date') is-invalid @enderror"
                                        name="date" value="{{ old('date', $date) }}" />
                                    @error('date')
                                                                    ...
                                                                    <div class="input-group-text mx-2">
                                                                        <div class="custom-radio">
                                                                            <input type="radio"
                                                                                ...
                                                                                {{ $attendence->status == 'leave' ? 'checked' : '' }}
                                                                                disabled>
                                                                            <label class="custom-control-label"
                                                                    ...
                                                                    <div class="input-group-text">
                                                                        <div class="custom-radio">
                                                                            <input type="radio"
                                                                                ...
                                                                                {{ $attendence->status == 'absent' ? 'checked' : '' }}
                                                                                disabled>
                                                                            <label class="custom-control-label"
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{ route('attendence.index') }}" class="btn btn-danger">Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
